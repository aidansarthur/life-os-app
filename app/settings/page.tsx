...
const whoopMessages: Record<string, string> = {
  ...
  refresh_failed: "Your WHOOP session expired. Reconnect WHOOP."
};
        ...
        <section className="rounded-lg border border-ink/10 bg-white p-5 shadow-soft">
          ...
          <div className="space-y-4">
            {isWhoopConnected ? (
              ...
              <p className="leading-7 text-ink/70">Connect WHOOP to authorize recovery, sleep, cycle, workout, and profile data for your personal dashboards and reports.</p>
            )}
            ...
            <Link href="/api/whoop/connect" className="focus-ring inline-flex items-center justify-center gap-2 rounded-md bg-ink px-4 py-2 text-sm font-bold text-white">
              ...
              {isWhoopConnected ? "Reconnect WHOOP" : "Connect WHOOP"}
            </Link>
          </div>
        </section>
        <section className="rounded-lg border border-ink/10 bg-white p-5 shadow-soft">
          ...
          <p className="leading-7 text-ink/70">Auth and database hooks are scaffolded. Add your Supabase URL and anonymous key to local environment variables, then connect the pages to real tables.</p>
